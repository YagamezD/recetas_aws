...
class Recipe:
    ...
    def save(cls, formulario):
        query = "INSERT INTO recipes (name, under30, description, instruction, date_made, user_id) VALUES ( %(name)s, %(under30)s, %(description)s, %(instructions)s, %(date_made)s, %(user_id)s )"
